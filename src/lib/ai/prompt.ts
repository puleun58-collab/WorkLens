  ...
  switch (request.operation) {
    ...
    case "analyze":
      return [
        ...
        "role이 summary인 claim으로 서로 다른 핵심을 최대 5개까지 요약하세요. 근거가 뒷받침하는 만큼만 쓰고 개수를 채우려고 만들지 마세요.",
        ...
        "근거에 조건과 결과, 선후관계, 변화의 연결 또는 비교처럼 해석할 관계가 실제로 나타나면 role이 insight인 claim을 서로 다른 관계에 대해 최대 3개까지 덧붙이세요. 요약을 말만 바꿔 반복하거나 단순 field/value를 insight로 분류하지 마세요. 관계가 없으면 insight를 만들지 마세요.",
